          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                _buildStationStep('Station 2: Physical & POP Exam', 'शारीरिक जाँच र आङ्ग खस्ने चरण', isCompleted: false),
                const Divider(height: 12),
                _buildStationStep('Station 3: Vitals & Lab Testing', 'रक्तचाप, सुगर र ल्याब परीक्षण', isCompleted: false),
                const Divider(height: 12),
                _buildStationStep('Station 4: Doctor Assessment', 'चिकित्सक रोग निदान', isCompleted: false),
                const Divider(height: 12),
                _buildStationStep('Station 5: Treatment & Pharmacy', 'औषधि, पेसरी र परामर्श', isCompleted: false),
                const Divider(height: 12),
                _buildStationStep('Station 6: Discharge & Referral', 'अन्तिम सल्लाह र अस्पताल प्रेषण', isCompleted: false),
              ],
            ),
          ),
