...
echo   Central Sync Server : http://192.168.110.108:8080
...
flutter run -d all --web-port=5000 --dart-define=CENTRAL_SERVER_URL=http://192.168.110.108:8080 --dart-define=GEMINI_API_KEY=%GEMINI_API_KEY%
